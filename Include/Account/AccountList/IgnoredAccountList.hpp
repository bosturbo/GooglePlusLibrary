...
/*!
* @~english
* @brief Class to get a list of accounts was ignored
* @~japanese
* @brief 無視したアカウントのリストを取得するためのクラス
*/
class GOOGLEPLUSLIBRARY_API IgnoredAccountList
{
public:
	IgnoredAccountList(void);
...
private:
	virtual ~IgnoredAccountList(void);
