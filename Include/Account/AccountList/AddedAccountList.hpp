...
/*!
* @~english
* @brief Class to get a list of accounts the user has added to the circle
* @~japanese
* @brief ユーザーがサークルに追加したアカウントのリストを取得するためのクラス
*/
class GOOGLEPLUSLIBRARY_API AddedAccountList
{
