...
/*!
* @~english
* @brief Class to get a list of accounts was blocked
* @~japanese
* @brief ブロックしたアカウントのリストを取得するためのクラス
*/
class GOOGLEPLUSLIBRARY_API BlockedAccountList
{
public:
	BlockedAccountList(void);
...
private:
	virtual ~BlockedAccountList(void);
